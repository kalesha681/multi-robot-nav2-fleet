...
WAYPOINTS = {
    ...
    'AMR1_STAGE3_RAMP_NORTH': (-1.0, 6.0, 0.707, 0.707),     # Stage 3: Exact opposite point on North side across ramp
    ...
    'RAMP_NORTH_EXIT': (-1.0, 6.0, 0.707, 0.707),
    'HEAVY_STORAGE': (-1.0, 6.0, 0.707, 0.707),
